...
class ExcelUploader:
    ...
    def __init__(self):
        ...
        self.database_url = "postgresql+psycopg2://postgres:ZtQKhXPQZLiyEgINSWDfRznAIcrJZhAx@gondola.proxy.rlwy.net:15963/railway"
        self.engine = None
        # 업로드할 파일 목록
        self.files_to_upload = [
            {
                "file_path": r"C:\Users\bit\taeheonai\docs\직원.xlsx",
                "table_name": "employee",
                "primary_key": "id",
                "description": "직원 정보"
            },
            {
                "file_path": r"C:\Users\bit\taeheonai\docs\손익계산.xlsx",

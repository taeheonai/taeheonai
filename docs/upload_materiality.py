...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgresql+psycopg2://postgres:REDACTED_DB_PASSWORD_1@gondola.proxy.rlwy.net:15963/railway")
...
def get_engine() -> Engine:
    if not DATABASE_URL:
        die("DATABASE_URL is not set. Example: postgresql+psycopg2://postgres:REDACTED_DB_PASSWORD_1@gondola.proxy.rlwy.net:15963/railway")
    try:

...
export class GRIApiService {
  ...
  static async getCategories(): Promise<{ categories: GRICategory[]; count: number }> {
    try {
      const response = await api.get('/api/v1/gri/categories');
  ...
  static async getCompleteData(categoryId: number): Promise<GRICompleteData> {
    try {
      const response = await api.get(`/api/v1/gri/complete/${categoryId}`);
      return response.data;
    } catch (error: unknown) {
  ...
  static async createAnswer(answerData: AnswerCreate): Promise<AnswerResponse> {
    try {
      const response = await api.post('/api/v1/gri/answers', answerData);
      return response.data;
    } catch (error: unknown) {
  ...
  static async getProgress(sessionKey: string): Promise<ProgressResponse> {
    try {
      const response = await api.get(`/api/v1/gri/progress/${sessionKey}`);
      return response.data;
    } catch (error: unknown) {
  ...
  static async getAnswers(sessionKey?: string, page: number = 1, size: number = 10) {
    try {
      ...
      const response = await api.get('/api/v1/gri/answers', { params });
      return response.data;
    } catch (error: unknown) {
  ...
  static async updateAnswer(answerId: number, answerData: AnswerCreate): Promise<AnswerResponse> {
    try {
      const response = await api.put(`/api/v1/gri/answers/${answerId}`, answerData);
      return response.data;
    } catch (error: unknown) {
  ...
  static async deleteAnswer(answerId: number): Promise<{ deleted_id: number }> {
    try {
      const response = await api.delete(`/api/v1/gri/answers/${answerId}`);
      return response.data;
    } catch (error: unknown) {
  ...
  static async runPolish(request: PolishRequest) {
    try {
      ...
      const { data } = await api.post('/api/v1/gri/polish', request, { 
  ...
  static async getPolishResult(sessionKey: string, griIndex: string) {
    try {
      const { data } = await api.get(`/api/v1/gri/polish/${sessionKey}/${griIndex}`);
  ...
  static async listPolishResults(sessionKey: string) {
    try {
      const response = await api.get(`/api/v1/gri/polish/${sessionKey}`);
      return response.data;
    } catch (error: unknown) {

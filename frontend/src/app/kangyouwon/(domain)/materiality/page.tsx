...
import NavigationTabs from '@/components/kangyouwon/NavigationTabs';
import { MediaCard, MediaItem } from '@/components/kangyouwon/MediaCard';
import IndexBar from '@/components/kangyouwon/IndexBar';
import { useMediaStore } from '@/store/kangyouwon/mediaStore';
import { IssuepoolData } from "../../lib/types";
import axios from 'axios';
import * as XLSX from 'xlsx';
import { useExcelDataStore } from '@/store/kangyouwon/excelDataStore';
import FinalIssuepool from '@/components/kangyouwon/materiality/box/final_issuepool';
import MediaSearch from '@/components/kangyouwon/materiality/box/media_search';
import SearchResult from '@/components/kangyouwon/materiality/box/media_search_result';
import FirstAssessment from '@/components/kangyouwon/materiality/box/middle_issuepool';
import SurveyUpload from '@/components/kangyouwon/materiality/box/survey_upload';
import SurveyCreate from '@/components/kangyouwon/materiality/box/survey_create';
import SurveyManagement from '@/components/kangyouwon/materiality/box/survey_send';
import SurveyResult from '@/components/kangyouwon/materiality/box/survey_result';
import Finish from '@/components/kangyouwon/materiality/box/finish';
import { handleViewReport } from '@/components/kangyouwon/materiality/handle_view_report';
import { loadAssessmentResult } from '@/components/kangyouwon/materiality/load_assessment_result';
import { fetchAllCategories } from '@/components/kangyouwon/materiality/fetch_all_categories';

import { addNewCategory } from '@/components/kangyouwon/materiality/add_new_category';
import { getESGClassification } from '@/components/kangyouwon/materiality/get_esg_classification';

...
import SearchResult from '@/components/materiality/box/media_search_result';
import FirstAssessment from '@/components/materiality/box/middle_issuepool';
import SurveyUpload from '@/components/materiality/box/survey_upload';
import SurveyCreate from '@/components/materiality/box/survey_create';

...
DATA_PATH = "./data/hanon_2024_gri_fixed.jsonl"                  # 한온시스템 데이터
...
def load_and_prepare_dataset(path: str):
    print(f"데이터 로딩 중: {path}")
    ds = load_dataset("json", data_files=path, split="train")
    print(f"로딩된 데이터: {len(ds)}개")
    
    # 35개 데이터는 작으므로 90/10 분할
...
# ---------- 메인 ----------
def main():
    print("🚀 기존 모델에 한온시스템 데이터 추가 학습 시작!")
    ...
    print(f"🎉 통합 학습 완료! 출력: {OUTPUT_DIR}")
